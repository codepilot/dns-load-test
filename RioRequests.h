...
class SendExRequest: public RequestBase {
public:
	SendExRequest(LPFN_RIOSENDEX _RIOSendEx, RIO_RQ _requests, PRIO_BUF _pData, PRIO_BUF _pRemoteAddress) : RequestBase{ _RIOSendEx, _requests, _pData, _pRemoteAddress }  {
